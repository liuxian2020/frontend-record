                ...
                <div class="menu-box">
                  <div class="product-group" v-for="(item, index) in menus" :key="index">
                    ...
                    <div class="first-title"
                      :class="{ 'is-menu-check': item.isCheck, 'is-menu-click': activeMenu.indexOf(item.url) > -1 }">
                      <app-link class="link-box" :to="resolvePath(item.url)">
                    ...
                    <!-- 二级菜单 -->
                    <div class="second-title" :class="{ 'is-submenu-check': activeMenu === inner.url }"
                      v-for="(inner, index2) in item.children" :key="index2">
                      ...
                      <div class="star-box">
                        <i class="el-icon-star-off" @click.stop="getSelectMenu(inner)"
                          :class="{ 'active': inner.isChoice }"></i>
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  data () {
    return {
      ...
      permission_menus: [
        { "id": "c9b5cfe8aea0fa3f62cd5089d6709521", "text": "统计分析", "url": "/screenAnalysis", "code": "LogIndex", "icon": "shiyoudanwei", "sortNum": 1, "children": [] },
        {
          "id": "fdf5d9a6f47dcb6d857b71c57b47f6f8", "text": "用户中心", "url": "/systemManage", "code": "UC", "icon": "kongzhitai", "sortNum": 1,
          "children": [{ "id": "fac61355d81a311d4172c0118e50a6ed", "text": "账号安全", "url": "/systemManage/control", "code": "UCAccountIndex", "icon": null, "sortNum": 2, "children": [] }]
        },
        {
          "id": "f765554764a001682891022a6c422936", "text": "指纹平台", "url": "/fingerprint", "code": "fingerprint", "icon": "kaoqin", "sortNum": 2,
          "children": [{ "id": "4d54fe7918c6265a66570dc7be8c0223", "text": "指纹库", "url": "/fingerprint/database", "code": "FingerprintDatabaseIndex", "icon": "avdsloudongsaomiao", "sortNum": 1, "children": [] }, { "id": "8b38a8208857d979fe0895db47a6c67d", "text": "配置管理", "url": "", "code": "ConfigIndex", "icon": "shangchuan-", "sortNum": 2, "children": [{ "id": "6e52a82b095a57a8c2ddec071376bb98", "text": "类别管理", "url": "/fingerprint/config/category", "code": "ConfigIndex", "icon": null, "sortNum": 1, "children": [] }, { "id": "ca4f145865c4f21596927aa4e25f3d94", "text": "协议管理", "url": "/fingerprint/config/protocal", "code": "ConfigIndex", "icon": null, "sortNum": 2, "children": [] }, { "id": "a54d86dc0160f22e447e9ec8439a1d3d", "text": "服务对象管理", "url": "/fingerprint/config/object", "code": "ConfigIndex", "icon": null, "sortNum": 3, "children": [] }, { "id": "d24071d265d49ebd13f5e123aee092eb", "text": "指纹同步记录", "url": "/fingerprint/config/record", "code": "ConfigIndex", "icon": null, "sortNum": 4, "children": [] }] }, { "id": "d1d62082d3d84d32c6eec0bf5a7fe3b9", "text": "运行监控", "url": "/fingerprint/control", "code": "ControlIndex", "icon": "fenlei", "sortNum": 3, "children": [] }]
        },
        {
          "id": "37080f6c588963ce24e159c7db5a3367", "text": "威胁情报中心", "url": "/threatCenter", "code": "LogIndex", "icon": "anquanjiance1", "sortNum": 3,
          "children": [{ "id": "092a98677e3792061631f3c4d61d6e51", "text": "威胁情报中心", "url": "/threatCenter/threat", "code": "LogIndex", "icon": null, "sortNum": 1, "children": [] }]
        },
        {
          "id": "3e472bd1061ed2cd10f57e8182030cae", "text": "设备管理", "url": "/deviceManage", "code": "DeviceIndex", "icon": "shebeiguanli", "sortNum": 5,
          "children": [{ "id": "f6ca659cc82520741e83eb60806c5da6", "text": "设备诊断", "url": "/deviceManage/diagnose", "code": "DeviceDiagnoseIndex", "icon": null, "sortNum": 1, "children": [] }, { "id": "1319448993843f762055aec04cb3002c", "text": "裸命令", "url": "/deviceManage/command", "code": "DeviceCommandIndex", "icon": null, "sortNum": 2, "children": [] }, { "id": "27e0d5e265678ed028467f8b3b5f4f60", "text": "go-mqtt", "url": "/deviceManage/mqtt", "code": "DeviceMqttIndex", "icon": null, "sortNum": 2, "children": [] }, { "id": "7d90fc24ad69ed37475b20cad38f2c4f", "text": "远程隧道", "url": "/deviceManage/tunnel", "code": "DeviceTunnelIndex", "icon": null, "sortNum": 3, "children": [] }, { "id": "8cdcc85b3dbccabfba0012a7ab83613c", "text": "文件资源管理", "url": "/deviceManage/fileManage", "code": "DeviceFileIndex", "icon": null, "sortNum": 4, "children": [] }, { "id": "fa21197511bae3b43edc2db6a8103651", "text": "知识库", "url": "/deviceManage/knowledge", "code": "DeviceKnowledgeIndex", "icon": null, "sortNum": 5, "children": [] }]
        },
        { "id": "bca391c6dc00a81b2583c4bf1789c9d2", "text": "组织架构", "url": "/organization", "code": "OrgIndex", "icon": "fenzu", "sortNum": 5, "children": [] },
        {
          "id": "cacf7ad8e340aad52104c23396568876", "text": "权限管理", "url": "/authorityManage", "code": "Auth", "icon": "quanxianguanli", "sortNum": 10,
          "children": [{ "id": "2c7d03e349eadc4f6f531e7d265c348c", "text": "角色管理", "url": "/authorityManage/list", "code": "AuthListIndex", "icon": null, "sortNum": 1, "children": [] }, { "id": "d214df42e5e2520c92f14f3d7df51fc4", "text": "账号管理", "url": "/authorityManage/account", "code": "AuthAccountIndex", "icon": null, "sortNum": 2, "children": [] }, { "id": "c3aede84a74da1602d73df78d34b93dd", "text": "菜单管理", "url": "/authorityManage/menu", "code": "AuthMenuIndex", "icon": "", "sortNum": 3, "children": [] }]
        },
        { "id": "601c095a7f90a386d86bd50edd5f8703", "text": "日志管理", "url": "/logManage", "code": "LogIndex", "icon": "rizhiguanli", "sortNum": 14, "children": [] },
        { "id": "81b8513a55f6aaad38e511c9db658a74", "text": "NDR文件配置管理", "url": "/server", "code": "LogIndex", "icon": "ceshi", "sortNum": 15, "children": [] },
        {
          "id": "4f57919a5538fe9db78b7defc2d59cda", "text": "运营中心", "url": "/operationCenter", "code": "LogIndex", "icon": "yunying", "sortNum": 17,
          "children": [{ "id": "b63aa080e8affbc691af83fafc6a0978", "text": "规则库", "url": "/operationCenter/knowledge", "code": "OPRepositoryIndex", "icon": "yunying", "sortNum": 1, "children": [] }, { "id": "29ae81bf15ff070d3ae36a395c3fcd56", "text": "设备管理", "url": "/operationCenter/control", "code": "LogIndex", "icon": "2", "sortNum": 2, "children": [] }, { "id": "6a74245dcd599223b5d37e68dbf33ff9", "text": "处置中心", "url": "/operationCenter/disposalCenter", "code": "PendFallIndex", "icon": null, "sortNum": 3, "children": [] }, { "id": "33eff65e66b284ffb1bd887f42b90a2e", "text": "协同防御", "url": "/operationCenter/defense", "code": "LogIndex", "icon": null, "sortNum": 4, "children": [] }]
        },
        {
          "id": "277ba18baaf6c3d50dfab5cfa20fd1f8", "text": "漏扫管理", "url": "/leakManage", "code": "LogIndex", "icon": "avdsloudongsaomiao", "sortNum": 18,
          "children": [{ "id": "3a9b5e11ae67446ece51bc7417ee1bfd", "text": "固定漏扫节点管理", "url": "/leakManage/fixedNodes", "code": "LogIndex", "icon": null, "sortNum": 1, "children": [] }, { "id": "ad604386b1648ee467fb0b8b1e8acb04", "text": "漏扫节点数量配置", "url": "/leakManage/DynamicNode", "code": "LogIndex", "icon": null, "sortNum": 2, "children": [] }, { "id": "37300047ab0b777ff061fe5377e6ceda", "text": "不可用漏扫节点管理", "url": "/leakManage/unusable", "code": "LogIndex", "icon": null, "sortNum": 3, "children": [] }, { "id": "fb10212c8aef5cdf968f5dd5086f2faa", "text": "动态漏扫节点管理", "url": "/leakManage/dynamic", "code": "LogIndex", "icon": null, "sortNum": 4, "children": [] }]
        },
        {
          "id": "c68a5e98e71faa2c6984397a6387c0aa", "text": "管理平台", "url": "/plManage", "code": "LogIndex", "icon": "guanlipingtai", "sortNum": 20,
          "children": [{ "id": "791685f2bcecb4be4f74cee0a785c598", "text": "平台管理", "url": "/plManage/plform", "code": "LogIndex", "icon": null, "sortNum": 1, "children": [] }, { "id": "3872e0e136e2ba1204abd694da0a4f4f", "text": "版本管理", "url": "/plManage/versions", "code": "LogIndex", "icon": null, "sortNum": 2, "children": [] }, { "id": "3cf766f6e3425af7fed66aa5c68c90d2", "text": "服务管理", "url": "/plManage/service", "code": "LogIndex", "icon": null, "sortNum": 3, "children": [] }, { "id": "a8fa03d58e6363bb270c44c07be24343", "text": "客户端管理", "url": "/plManage/client", "code": "LogIndex", "icon": null, "sortNum": 4, "children": [] }]
        }]
